<div class="pt-10 mt-10 border-t border-gray-100 comments-box">
    ...
    @else
        <a wire:navigate class="py-1 text-purple-500" href="{{ route('login') }}"> Login to Post Comments</a>
    @endauth
    ...
    <div class="px-3 py-2 mt-5 user-comments">
        @forelse($this->comments as $comment)
            <div class="comment [&:not(:last-child)]:border-b border-gray-100 py-5">
                        ...
                        @if(auth()->user()->id === $comment->user_id)
                            <div>
                                <button
                                    ...
                                    class="bg-gray-600 text-white px-2 py-1 rounded-lg">
                                    Edit
                                </button>
                                <button
                ...
                <div class="text-sm text-justify bg-gray-50 rounded-lg p-3">
                    {{ $comment->comment }}
                </div>
                @empty
